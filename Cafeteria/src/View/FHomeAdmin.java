 ...
 * @author fatec_aluno
 */
public class FHomeAdmin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblSaldoGeral.setText("R$ 1500.00");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FHomeAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
